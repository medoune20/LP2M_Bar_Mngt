...
public static class ModulesApp
{
    public static readonly (string Cle, string Nom)[] Liste = new[]
    {
        ...
        ("restaurant",         "Service restaurant (tables)"),
        ("cuisine_kds",        "Cuisine KDS"),
    ...
    public const string PermissionsAdministrateur =
        "dashboard=CM;caisse_rapide=CM;restaurant=CM;cuisine_kds=CM;ventes=CM;caisse=CM;produits=CM;categories=CM;stock=CM;clients=CM;fidelite=CM;depenses=CM;rapports=CM;comptabilite=CM;previsions=CM;evaluation_caissiers=CM;utilisateurs=CM;profils=CM;tenants=CM;sauvegarde=CM;parametres=CM";

    public const string PermissionsManager =
        "dashboard=C;caisse_rapide=CM;restaurant=CM;cuisine_kds=CM;ventes=CM;caisse=CM;produits=CM;categories=CM;stock=CM;clients=CM;fidelite=CM;depenses=CM;rapports=C;comptabilite=CM;previsions=C;evaluation_caissiers=C;parametres=C";

    public const string PermissionsCaissier =
        "dashboard=C;caisse_rapide=CM;restaurant=CM;cuisine_kds=CM;ventes=C;caisse=C;produits=C;categories=C;stock=C;clients=C;fidelite=C";
